...
<body>
  <h1>Alimente ce mini chat en postant un message! (255 charactères maxi!)</h1>
  <form action="minichat_post.php" method="post">
    <p>
      <label for="pseudo">Pseudo :</label> <input type="text" name="pseudo" id="pseudo"><br>
      <label for="message">Message :</lab#ecedcbel>  <textarea name="message" id="message" maxlength="255"></textarea><br>
